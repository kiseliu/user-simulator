...
class Seq_User_Act(Seq_User):
    ...
    def respond(self, sys_act, prev_sys=None):
        ...
        if act == 'inform_type':
            ...
            slot_names = sorted(random.sample(avail_slot, k=random.choice(range(1,len(avail_slot)+1))))
        elif act == 'inform_type_change':
            ...
            avail_slot = self.goal - self.state['']
    ...
    def success_or_not(self, prev_usr, prev_sys, cur_usr, sys_act):
        ...
        elif re.search(r'value_time|value_day|value_people', self.m.reader.delex_sent(prev_usr)) or \
           re.search(r'reference number|reservation number', prev_usr):
            # # reference number
        ...
        elif re.search(r'value_area|value_food|value_pricerange', self.m.reader.delex_sent(prev_usr)):
        ...
        elif re.search(r'restaurant_name', self.m.reader.delex_sent(prev_usr)):
